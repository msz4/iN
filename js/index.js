var app = {
    ...
    "sOptions":{"NE": ["Adamawa", "Bauchi", "Borno", "Gombe", "Taraba", "Yobe"], "NW": ["Jigawa", "Kano", "Kaduna", "Katsina", "Kebbi", "Sokoto", "Zamfara"], "NC" : ["Niger", "Kogi", "Benue", "Plateau", "Nassarawa", "Kwara", "Federal Capital Territory"], "SE": ["Enugu", "Imo", "Ebonyi", "Abia", "Anambra"], "SS": ["Bayelsa", "Akwa Ibom", "Edo", "Rivers", "Cross River", "Delta"], "SW": ["Oyo", "Ekiti", "Osun", "Ondo", "Lagos", "Ogun"]}
        ...
        this.capitals1=" <div class='vertical-top'> <div class ='container'> <table class='table' > <thead> <tr> <th> <a href ='' id='home'><i class='fa fa-arrow-left' style='font-size:36px; color: #1493E2'></i></a></th> <th style='text-align: right'><h3 id ='score'>0</h3></th> <th style='text-align: right' id = 'lives'><i class='fa fa-heart' style='font-size:36px; color: #1493E2'></i>x3</th> </tr> </thead> </table></div></div> <div class='vertical-center-quiz'> <div class ='container'> <center> <div class ='row' style='justify-content:center'> <div class='col-lg-6' > <h1 style='font-family: gameFont' id ='que'></h1> </div> </div> </center> <br> <br> <div class='row' > <div class='col-lg-6' style='border-bottom: 5px solid #fff;'> <button type='button' id ='opt1c' class='btn btn-primary btn-block' ><h4 id ='opt1c_'></h4></button> </div> <div class='col-lg-6' style='border-bottom: 5px solid #fff;'> <button type='button' id ='opt2c', class='btn btn-primary btn-block'><h4 id ='opt2c_'></h4></button> </div> <br> <div class='col-lg-6' style='border-bottom: 5px solid #fff;'> <button type='button' id ='opt3c' class='btn btn-primary btn-block'><h4 id ='opt3c_'></h4></button> </div> <div class='col-lg-6' style='border-bottom: 5px solid #fff;'> <button type='button' id ='opt4c' class='btn btn-primary btn-block'><h4 id ='opt4c_'></h4></button> </div> </div> </div></div>";
        ...
        this.homepage = " <nav class='navbar navbar-default navbar-fixed-top' style='background-color: #1493E2'><div class='container'><img src='img/logo.png' style='max-width:100%'></div></nav><div class='vertical-center-quiz'><div class ='container'> <div class='row '> <div class='col align-self-start'></div> <div class='col-lg-6 align-self-center'> <a href='#' id='btn_playcapitals1' class='btn btn-light btn-block'><h4>Capitals: Regular <kbd id='statsCapitals1'>0/37</kbd></h4></a> <a href='#' id='btn_playcapitals2' class='btn btn-outline-primary btn-block'><h4 id ='lockedCapitals' >Capitals: Challenging <br><kbd id='statsCapitals2'><i class='fa fa-lock'></i></kbd></h4></a> <a href='#' id='btn_playstates1' class='btn btn-outline-primary btn-block'><h4>States: Regular<br><kbd id='statsStates1'>0/37</kbd></h4></a> <a href='#' id='btn_playstates2' class='btn btn-outline-primary btn-block'><h4 id='lockedStates'>States: Challenging<br> <kbd id='statsStates2'><i class='fa fa-lock'></i></kbd></h4></a> </div> <div class='col align-self-end'></div> </div></div> </div>";
