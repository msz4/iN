var app = {
    ...
    receivedEvent: function(id) {
        ...
        correct_sound = new Media('file///android_asset/www/sound/correct.wav');
        wrong_sound = new Media('file///android_asset/www/sound/wrong.wav');
        nav_sound = new Media('file///android_asset/www/sound/nav.wav');
