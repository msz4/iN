var app = {
    ...
    receivedEvent: function(id) {
        ...
        correct_sound = new Media('sound/correct.wav');
        wrong_sound = new Media('sound/wrong.wav');
        nav_sound = new Media('sound/nav.wav');
